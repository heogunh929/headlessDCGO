...
- [ ] **B2. Select* 컴포넌트군** — **재하우징(저위험)**
  ...
  - `SelectHandEffect` (RD-P6C1-7 / **RD-P8-01 BT1_039**): **[상환 완료 — R5-A 00552dbf]** Script/SelectHandEffect.cs 550줄 1:1 실구현(Mode 7종·SetUp 12-param). BT1_039/056·BT22_035·BT8_092 재포팅됨. **수리-9: BT9_109 [When Attacking]도 이 위에 재활(RD-P6C3-D1+D2 상환)**.
