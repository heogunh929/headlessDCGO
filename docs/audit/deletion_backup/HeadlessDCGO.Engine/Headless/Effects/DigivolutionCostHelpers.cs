...
// 미러 원가(재이관 대상): Script/CardSource.cs::CardSource.EvoCosts/BaseEvoCostsFromEntity/PayingCost@CardSource.cs:534(EvoCosts)/528(BaseEvoCostsFromEntity)/585-600(color@level 매칭)/635(PayingCost)
