...
// 미러 원가(재이관 대상): Script/CardEffectCommons/GetFromHashtable.cs;Script/CardEffectCommons/HashtableSetting.cs::GetFromHashtable(hashtable 키 읽기)@GetFromHashtable.cs; HashtableSetting.cs
