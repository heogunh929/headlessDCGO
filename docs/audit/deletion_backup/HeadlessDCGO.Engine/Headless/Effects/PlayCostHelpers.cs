...
// 미러 원가(재이관 대상): Script/CardSource.cs::CardSource.GetCostItself/PayingCost/GetChangedPayingCost/GetChangedCostItselef (IChangeCostEffect 파이프라인)@CardSource.cs:769(GetCostItself)/635(PayingCost)/664(GetPayingCostWithBas
