...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardController.cs::IDegeneration.Degeneration (De-Digivolve 톱트래시+StopCondition rookie floor level==3); ArmorPurge는 CardEffectCommons/KeyWordEffects/ArmorPurge.cs; 면역은 Perman
