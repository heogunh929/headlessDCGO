...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/Permanent.cs::Permanent.IsDigimon / Has<Keyword> 게터들 (HasBlocker/HasJamming/HasPierce/HasReboot/HasRush…) + ITreatAsDigimonEffect·IImmuneFromDeDigivolveEffect 인터페이스 스캔@Perma
