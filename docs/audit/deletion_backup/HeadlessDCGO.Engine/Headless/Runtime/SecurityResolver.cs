...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardController.cs::CardController.ISecurityCheck.SecurityCheck (StopSecurityCheck 재평가·Strike 카운트·[Security]효과·OnSecurityCheck/OnLoseSecurity 창·시큐리티 디지몬 전투); DestroyPermanent
