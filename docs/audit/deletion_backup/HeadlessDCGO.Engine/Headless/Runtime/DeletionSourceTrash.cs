...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/Permanent.cs::Permanent.DiscardEvoRoots(진화소스+링크카드 언컨디셔널 trash) + AceOverflowClass.Overflow(CardController.cs) ACE 메모리 페널티@Permanent.cs:106(DiscardEvoRoots def
