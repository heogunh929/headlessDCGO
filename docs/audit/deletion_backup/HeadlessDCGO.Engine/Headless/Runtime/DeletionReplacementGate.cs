...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardEffectCommons/KeyWordEffects/::EvadeProcess(Evade.cs willBeRemoveField=false)·BarrierProcess(Barrier.cs)·CanActivateFortitude+GetDigivolutionSourcesFromHashtable(Fortitu
