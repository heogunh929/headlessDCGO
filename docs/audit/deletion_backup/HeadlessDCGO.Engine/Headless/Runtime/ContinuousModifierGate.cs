...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardSource.cs::CardSource.GetPayingCostWithBaseCost (+ GetChangedCostItselef/GetChangedPayingCost cost fold); 지속 시큐리티어택 수정자는 ContinuousController.cs@CardSource.cs:664(GetPay
