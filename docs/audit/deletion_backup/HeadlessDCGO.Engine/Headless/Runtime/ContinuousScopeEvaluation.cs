...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/ContinuousController.cs::ContinuousController (지속효과 적용범위·player-scope condition 재평가); ApplicableEffects는 현재 빈 배열(producer 0)@ContinuousController.cs(클래스 존재 확인); substrate Ap
