...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardEffectCommons/CanUseEffects/OnDeletion.cs::OnDeletion cut-in window(CanActivateOnDeletion) + WhenPermanentWouldBeDeleted/WhenRemoveField 타이밍(CardController.WhenPermanent
