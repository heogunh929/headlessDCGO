...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardObjectController.cs; DCGO/Assets/Scripts/Script/TurnStateMachine.cs::CardObjectController.CreatePlayerDecks (덱 생성/셔플/시드); TurnStateMachine.StartGame (초기 핸드 딜=5장, 시큐리티 딜)
