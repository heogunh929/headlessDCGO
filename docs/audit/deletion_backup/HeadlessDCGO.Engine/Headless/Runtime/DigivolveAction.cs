...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/CardController.cs::진화 오케스트레이션 (isEvolution 아암 permanent.AddCardSource; IsAppFusion→CanAppFusionFromTargetPermanent; selectAppFusionEffect.AddToSources)@1365;400;787 | DCGO/A
