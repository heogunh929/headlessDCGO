...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/Player.cs; DCGO/Assets/Scripts/Script/SecurityObject.cs; DCGO/Assets/Scripts/Script/ContinuousController.cs::(전용 규칙 클래스 없음) DefaultVisibility/IsSecretFromOwner ↔ 면다운 렌더 관례@2
