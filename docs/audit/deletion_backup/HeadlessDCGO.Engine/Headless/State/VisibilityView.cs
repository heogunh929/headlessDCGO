...
// 미러 원가(재이관 대상): DCGO/Assets/Scripts/Script/Player.cs; DCGO/Assets/Scripts/Script/SecurityObject.cs::(전용 규칙 클래스 없음) 렌더링 면다운: Player 덱/디지타마 이미지 렌더 + SecurityObject.SetSecurity@297/329/126
