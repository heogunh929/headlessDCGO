...
- 원본: `DCGO/Assets/Scripts/CardEffect/BT1/Blue/BT1_086.cs`
- 원본 타이밍 분기: `OnEnterFieldAnyone`, `OnStartTurn`, `SecuritySkill`
...
**`TrashDigivolutionCardsFromTopOrBottom`** (CardEffectCommons)
...
- `CardEffectHashtable` (CardEffectCommons)
