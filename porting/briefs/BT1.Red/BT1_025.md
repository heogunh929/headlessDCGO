...
- 원본: `DCGO/Assets/Scripts/CardEffect/BT1/Red/BT1_025.cs`
- 원본 타이밍 분기: `None`, `OnEnterFieldAnyone`
...
**`CanTriggerWhenDigivolving`** (CardEffectCommons)
