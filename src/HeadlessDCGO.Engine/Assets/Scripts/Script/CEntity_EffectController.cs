...
// (C2 REHOUSED fold) CardEffectDispatch relocated from the separate CardEffectCommons/CardEffectDispatch.cs
// into its AS-IS home CEntity_EffectController.cs (AS-IS ClassName->Type resolution at
// CEntity_EffectController.cs:182-240). Verbatim; reflection-dictionary is the substrate translation of Type.GetType.
/// <summary>
