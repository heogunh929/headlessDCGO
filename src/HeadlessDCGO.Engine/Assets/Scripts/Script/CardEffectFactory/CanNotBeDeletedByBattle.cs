// Source: DCGO/Assets/Scripts/Script/CardEffectFactory/CanNotBeDeletedByBattle.cs
// (EFFECT-MODEL REBUILD / P4 vertical slice) 1:1 mirror of AS-IS CanNotBeDeletedByBattle.cs factory partial.
// Returns the ported CanNotBeDestroyedByBattleClass kind-class.
...
public partial class CardEffectFactory
{
    ...
    public static CanNotBeDestroyedByBattleClass CanNotBeDestroyedByBattleStaticEffect(Func<Permanent, Permanent, Permanent, CardSource, bool> canNotBeDestroyedByBattleCondition, Func<Permanent, bool> permanentCondition, bool isInheritedEffect, CardSource card, Func<bool> condition, string effectName, bool isLinkedEffect = false)
    {
        ...
        bool PermanentCondition(Permanent permanent)
        {
            ...
            {
                if (!permanent.TopCard.CanNotBeAffected(canNotBeDestroyedByBattleClass.EffectSourceCard?.InstanceId))
                {
