...
//
// 치환(substrate translations only): IEnumerator→async Task, StartCoroutine(X)→await X; SelectPermanentEffect.
// canTargetCondition은 정본 Func<Permanent,bool> — Permanent 술어 직결(id 어댑터 없음); `card.Owner.Enemy`
