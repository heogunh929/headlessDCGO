    ...
    public class LM_053 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Reveal the top 3 cards of your deck. Add 1 black or purple Digimon card among them to the hand. Return the rest to the bottom of deck. Then, place this card in the battle area.";
                }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    ...
                    new SelectCardConditionClass[]
                    {
                        new SelectCardConditionClass(
                            ...
                            message: "Select 1 black or purple Digimon card.",
                            maxCount: 1,
                            canEndNotMax:false,
