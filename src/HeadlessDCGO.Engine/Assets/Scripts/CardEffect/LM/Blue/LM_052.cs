    ...
    public class LM_052 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Reveal the top 3 cards of your deck. Add 1 blue or yellow Digimon card among them to the hand. Return the rest to the bottom of deck. Then, place this card in the battle area.";
                }
                ...
                bool CanSelectCardCondition(CardSource cardSource)
                {
                    ...
                    {
                        if (cardSource.HasCardColor(CardColor.Blue) || cardSource.HasCardColor(CardColor.Yellow))
                        {
                            return true;
                        }
                    }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    ...
                    new SelectCardConditionClass[]
                    {
                        new SelectCardConditionClass(
                            ...
                            message: "Select 1 blue or yellow Digimon card.",
                            maxCount: 1,
                            canEndNotMax:false,
