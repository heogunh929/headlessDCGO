...
//    * `CardEffectCommons.MatchConditionPermanentCount(CanSelectPermanentCondition)` → id-형 오버로드만
//      존재(BT17_026/BT24_018 idiom) — Permanent 술어는 그대로 두고 id 어댑터(PermanentOf/CanSelectPermanentById)
//      를 덧댐(술어 뭉갬 금지).
