...
{
    public class ST23_12 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Trash 1 face-down from under your Tamers to return 1 [Glowing Dawn] Digimon card", CanUseCondition, card);
