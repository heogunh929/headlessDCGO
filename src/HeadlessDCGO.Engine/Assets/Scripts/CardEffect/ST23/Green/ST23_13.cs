...
{
    public class ST23_13 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnDigivolutionCardDiscarded)
            {
                ...
                activateClass.SetUpICardEffect("Suspend this tamer to give 1 of your [Glowing Dawn] Digimon +3K DP until enemy turn ends", CanUseCondition, card);
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, true, EffectDescription());
                cardEffects.Add(activateClass);

                string EffectDescription()
                {
                    return "[Your Turn] When effects trash cards from under this Tamer, by suspending this Tamer, 1 of your [Glowing Dawn] trait Digimon gets +3000 DP until your opponent's turn ends.";
                }
                ...
                IEnumerator ActivateCoroutine(Hashtable hashtable)
                {
                    ...
                    selectPermanentEffect.SetUpCustomMessage("Select 1 Digimon that will get 3K DP.", "The opponent is selecting 1 Digimon that will get 3K DP.");
