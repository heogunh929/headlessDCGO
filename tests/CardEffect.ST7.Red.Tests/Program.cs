...
{
    ("ST7_10: Security Attack +1 is folded in by the continuous gate", () => Pure(SecurityAttackPlusOne)),
    ("ST7_10: Piercing keyword is registered and queryable", () => Pure(PiercingRegistered)),
    ("ST7_10: both effects register (1 continuous + 1 keyword)", () => Pure(BothEffectsRegister)),
};
